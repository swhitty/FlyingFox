...
[![Swift 5.6](https://img.shields.io/badge/swift-5.5%20|%205.7-red.svg?style=flat)](https://developer.apple.com/swift)
...
Gracefully shutdown the server, allowing requests time to complete before forcefully closing:
